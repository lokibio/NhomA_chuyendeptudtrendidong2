...
public class MainActivity extends TabActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		hotelSpec.setIndicator("",
				getResources().getDrawable(R.drawable.aic_hotel));
		...
		restaurantSpec.setIndicator("",
				getResources().getDrawable(R.drawable.aic_restaurant));
		...
		informationSpec.setIndicator("",
				getResources().getDrawable(R.drawable.aic_information));
		...
		hospitalSpec.setIndicator("",
				getResources().getDrawable(R.drawable.aic_hospital));
		...
		supermarketSpec.setIndicator("",
				getResources().getDrawable(R.drawable.aic_supermarket));
